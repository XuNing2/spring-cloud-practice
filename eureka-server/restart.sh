...
# Eureka Server 一键重启脚本
# 用法: ./restart.sh

echo "=========================================="
echo "   Eureka Server 一键重启脚本"
echo "=========================================="
...
JAR_FILE="target/eureka-server-1.0.0.jar"
LOG_FILE="/tmp/eureka-server.log"
PORT=8761
...
EUREKA_SERVER_PID=$!
echo "✅ $SERVICE_NAME 已启动 (PID: $EUREKA_SERVER_PID)"
